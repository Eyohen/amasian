...
const CategoryTable = () => {
  ...
  return (
    <div>
        ...
        <div className='p-9'>
        <p className='font-bold text-3xl text-blue-600'>Lamp Types</p>
      <div className="mb-4 text-right mt-4">
        ...
        <Link to={'/createcategory'}><button className='bg-blue-500 text-white px-6 py-2 rounded-md'>Create Lamp Category</button></Link>
      </div>
