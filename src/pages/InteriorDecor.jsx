...
const InteriorDecor = () => {
  return (
    <div className="min-h-screen font-['Libre_Baskerville',serif]">
      <h1 className='text-center font-bold text-3xl sm:text-4xl mt-8 sm:mt-12 px-4 uppercase'>Interior Architecture & Styling</h1>
      ...
      <div className='flex flex-col md:flex-row justify-center px-4 md:px-8 lg:px-16 mt-8 sm:mt-16 gap-y-6 md:gap-x-12 lg:gap-x-24 items-center bg-black py-6'>
        <img src={livingroom} alt="Living Room" className='w-full md:w-1/2 lg:w-[700px] h-auto md:h-[350px] lg:h-[450px] object-cover'/>
