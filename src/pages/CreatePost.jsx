...
const CreatePost = () => {
 ...
 <p onClick={() => navigate(-1)} className='flex items-center gap-x-2 cursor-pointer mb-8'>
                    Dashboard <MdOutlineKeyboardArrowRight /> Create blog post
                </p>
...
<button onClick={handlePost} className="bg-black text-white py-1">{isLoading ? "Creating ..." : "Create Post"}</button>
